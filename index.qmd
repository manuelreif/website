...
Privat interessiere ich mich für Astronomie, spiele viel zu selten GO
und probiere gerne mit {{< fa brands r-project >}} , Python (seit neuestem) und wie man hier sieht 
auch `quarto` herum. Ich bin Autor von drei R packages, die aber aus Zeitmangel
nicht mehr maintained werden.
