...
tool. Für decktape gibt es auch einen 
[Dockercontainer](https://hub.docker.com/r/astefanutti/decktape)^[Man muss sich wirklich nicht mit Docker auskennen um Docker verwenden zu können!] $\rightarrow$ 
...
1. `docker run`: okay, wir wollen irgendwas in docker machen, also soll der 
container der später genannt wird (`astefanutti/decktape`) *laufen*
...
Der container rechtnet damit, dass das .html file im Ordner "slides" liegt, daher wird der
