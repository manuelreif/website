---
title: "Logical"
description: "Logicals sind ein hervorragender Zeitvertreib, insbesondere wenn man sie mit Google OR-Tools und Python gelöst werden."
author: Manuel Reif 
date: 2024-02-10
...
Es schickte mir [seine Lösung](https://cocalc.com/haraldschilly/ideas/rockbands) 
...
docker run -v /home/USER/logical:/data logical_img python logical_python_functions.py --word_sum_file /data/word_sum_input.csv --outfile /data/loesung_docker.csv
```
